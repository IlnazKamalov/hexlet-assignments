...
public class AppTest {
    ...
    void testUpdatePerson() throws Exception {
        MockHttpServletResponse responseUpdate = mockMvc
                .perform(patch("/people/3")
                        .contentType(MediaType.APPLICATION_JSON.toString())
                        .content("{\"firstName\": \"Java\", \"lastName\": \"Top\"}"))
                .andReturn()
                .getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("Java", "Top");
        assertThat(response.getContentAsString()).doesNotContain("Jessica", "Simpson");
    }
